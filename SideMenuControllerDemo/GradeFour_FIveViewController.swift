...
class GradeFour_FiveViewController: BaseViewController
{
	override func setup()
	{
		super.setup()
	...
	func RandomQuestion2() -> (String, String, String, String, String, Bool, Bool, Bool, Bool, String)
	{
		...
		let numberThree = Int.random(in: 1..<10)
		let numberFour = Int.random(in: 1..<10)
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 4 Order of Operations Problems"
