...
class GradeFour_TwoViewController: BaseViewController
{
	...
	override func setup()
	{
		...
		self.title = "Grade 4 Subtraction"
		AppDelegate.Global_Variables.TheTitle = "Grade 4 Subtraction"
	}
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 4 Subtraction Problems"
