...
class GradeFive_OneViewController: BaseViewController
{
	override func setup()
	{
		super.setup()

		self.title = "Grade 5 Additions"
        AppDelegate.Global_Variables.TheTitle = "Grade 5 Additions"
	}

	func RandomQuestion2() -> (String, String, String, String, String, Bool, Bool, Bool, Bool, String)
	{
		let numberOne = Int.random(in: 1000..<3000)
		let numberTwo = Int.random(in: 1000..<3000)
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 5 Additions Problems"
