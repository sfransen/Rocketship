...
class GradeFour_OneViewController: BaseViewController
{
	...
	override func setup()
	{
		...
		self.title = "Grade 4 Additions"
        AppDelegate.Global_Variables.TheTitle = "Grade 4 Additions"
	}
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 4 Additions Problems"
