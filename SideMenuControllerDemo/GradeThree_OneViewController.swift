...
class GradeThree_OneViewController: BaseViewController
{
	...
	override func setup()
	{
		...
		self.title = "Grade 3 Additions"
        AppDelegate.Global_Variables.TheTitle = "Grade 3 Additions"
	}

	func RandomQuestion2() -> (String, String, String, String, String, Bool, Bool, Bool, Bool, String)
	{
		let numberOne = Int.random(in: 1..<1000)
		let numberTwo = Int.random(in: 1..<1000)
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 3 Additions Problems"
