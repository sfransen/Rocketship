...
class GradeTwo_ThreeViewController: BaseViewController
{
	override func setup()
	{
		super.setup()

		self.title = "Grade 2 Multiplication"
        AppDelegate.Global_Variables.TheTitle = "Grade 2 Multiplication"
	}
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 2 Multiplication Problems"
