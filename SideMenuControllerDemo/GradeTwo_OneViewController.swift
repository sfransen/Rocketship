...
class GradeTwo_OneViewController: BaseViewController
{
	...
	{
		let numberOne = Int.random(in: 1..<30)
		let numberTwo = Int.random(in: 1..<30)
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 2 Additions Problems"
