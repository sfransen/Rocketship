...
class GradeFour_ThreeViewController: BaseViewController
{
	override func setup()
	{
		super.setup()

		self.title = "Grade 4 Multiplication"
        AppDelegate.Global_Variables.TheTitle = "Grade 4 Multiplication"
	}

	func RandomQuestion2() -> (String, String, String, String, String, Bool, Bool, Bool, Bool, String)
	{
		let numberOne = Int.random(in: 1..<50)
		let numberTwo = Int.random(in: 1..<50)
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 4 Multiplication Problems"
