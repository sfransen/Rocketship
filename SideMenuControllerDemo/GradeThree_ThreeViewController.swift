...
class GradeThree_ThreeViewController: BaseViewController
{
	override func setup()
	{
		super.setup()

		self.title = "Grade 3 Multiplication"
        AppDelegate.Global_Variables.TheTitle = "Grade 3 Multiplication"
	}
	...
	func Create_New_Problem() -> (String)
	{
		...
		ViewTitle.textAlignment = NSTextAlignment.center
		ViewTitle.text = "Grade 3 Multiplication Problems"
